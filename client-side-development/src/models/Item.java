...
public class Item {
	...
	try {
		...
		if (rs.first())
		{
			itemsGrid = "<table border='1' cellspacing='1' cellpadding='1'><tr><th><th>No</th><th>Description</th><th>Edit</th><th>Delete</th></tr>";
			rs.beforeFirst();
			...
			while(rs.next())
			{
				itemsGrid = itemsGrid + "<tr><td>" + rs.getString(1) + "</td>"
						...
						+ "<td><input id=\"btnEdit\"type=\"button\"name=\"btnEdit\"param=\"" + rs.getString(1) + "\" value=\"Edit\"</td>" +"<td>" + "<input id=\"btnRemove\"type=\"button\"name=\"btnRemove\"param=\"" + rs.getString(1) + "\"value=\"Remove\"</td></tr>";				
			}			
		}
		else
